...
export default function ProductPolicy() {
  return (
    <section
      className="product-policy overflow-hidden py-112.5   relative
    after:content-['']
    after:absolute
    after:left-[15%]
    after:bottom-0
      ...
      <div className="w-(--container) mx-auto relative z-50">
        ...
        <div className="product-policy__rightside--colOne ml-auto flex flex-col items-center">
          ...
          <h5 className="font-manrope font-normal text-lg mb-5 product-policy__rightside--h5 text-center">
            Real-time policy enforcement at the moment of communication, before
            anything is sent.
          ...
          <ButtonCta classBtn={"mx-auto border-2 !border-black !px-8 !py-[9px] mt-6"}>
